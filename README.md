...
* ** Moteur Audio :** Synchronisation totale entre le fichier importé et le moteur audio (BPM, Swing, Séquences).
* ** Sécurité :** Protection anti-crash sur le BPM (Clamping 40-300).
